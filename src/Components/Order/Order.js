...
class ConncetedOrder extends Component{
    render() {
        ...
        return (
            <div>
                <div className="online-shop-title"> plz review order before purchase</div>
                <Table>
                    <TableHead>
                        <TableRow>
...
const Order= withRouter(connect(mapStateToProps)(ConncetedOrder));
